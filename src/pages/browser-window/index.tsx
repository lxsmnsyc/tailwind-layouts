...
const HTML = `
<div id="browser-window" class="p-8 w-full h-full flex items-center justify-center">
      ...
      <div class="w-full flex items-center justify-center absolute left-0">
        ...
        >
          <div class="flex items-center justify-center pl-4">
            <span class="text-green-500 w-4 h-4 mr-2">
              <svg
...
<script type="text/javascript">
  ...
  renderFallback(document.getElementById('browser-window'));
</script>
`;
