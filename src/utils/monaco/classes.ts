...
const CLASSES = [
  ...
  ...createLazyClass('backdrop-blur', (theme as Record<string, Theme>).backdropBlur),
  ...createLazyClass('backdrop-brightness', (theme as Record<string, Theme>).backdropBrightness),
  ...createLazyClass('backdrop-contrast', (theme as Record<string, Theme>).backdropContrast),
  ...createLazyClass('backdrop-grayscale', (theme as Record<string, Theme>).backdropGrayscale),
  ...createLazyClass('backdrop-hue-rotate', (theme as Record<string, Theme>).backdropHueRotate),
  ...createLazyClass('backdrop-invert', (theme as Record<string, Theme>).backdropInvert),
  ...createLazyClass('backdrop-opacity', (theme as Record<string, Theme>).backdropOpacity),
  ...createLazyClass('backdrop-saturate', (theme as Record<string, Theme>).backdropSaturate),
  ...createLazyClass('backdrop-sepia', (theme as Record<string, Theme>).backdropSepia),
  ...
  ...createClass('blur', (theme as Record<string, Theme>).blur),
  ...
  ...createClass('brightness', (theme as Record<string, Theme>).brightness),
  ...createClass('shadow', theme.boxShadow),
  ...createClass('contrast', (theme as Record<string, Theme>).contrast),
  ...
  ...createClass('drop-shadow', (theme as Record<string, Theme>).dropShadow),
  ...
  ...createClass('grayscale', (theme as Record<string, Theme>).grayscale),
  ...
  ...createClass('hue-rotate', (theme as Record<string, Theme>).hueRotate),
  ...
  ...createClass('invert', (theme as Record<string, Theme>).invert),
  ...
  ...createClass('saturate', (theme as Record<string, Theme>).saturate),
  ...createClass('scale', theme.scale),
  ...createClass('scale-x', theme.skew),
  ...createClass('scale-y', theme.skew),
  ...createClass('sepia', (theme as Record<string, Theme>).sepia),
  ...createClass('skew-x', theme.skew),
  ...createClass('skew-y', theme.skew),
  ...
  ...createLazyClass('translate-x', theme.translate),
  ...createLazyClass('translate-y', theme.translate),
